...
class Topic(ABC):
    ...
    def start(self, service_id: str):
        """
        sub topic to listen to by service, service should start upon message in this topic
        :param service_id:
        """
        pass
    ...
    def stop(self, service_id: str):
        """
        sub topic to listen to by service, service should stop upon message in this topic
        :param service_id:
        """
        pass
